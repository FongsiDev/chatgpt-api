...
type DeleteConversationJSONBody = {
    is_visible: boolean;
};
type Prompt = {
    /**
...
type DeleteConversationResponseEvent = {
    detail?: string;
    success?: string;
};
type Message = {
...
declare class ChatGPTUnofficialProxyAPI {
     ...
     * Delete Conversation
     */
    deleteConversation(conversationId: any): Promise<unknown>;
    genTitle(event: any): Promise<any>;
}

export { ChatGPTAPI, ChatGPTAPIOptions, ChatGPTError, ChatGPTUnofficialProxyAPI, ChatMessage, ContentType, ConversationJSONBody, ConversationResponseEvent, CreateChatCompletionStreamResponse, CreateCompletionStreamResponseUsage, DeleteConversation, DeleteConversationJSONBody, DeleteConversationResponseEvent, DeleteMessage, FetchFn, GetMessageByIdFunction, Message, MessageActionType, MessageContent, MessageMetadata, Prompt, PromptContent, Role, SendMessageBrowserOptions, SendMessageOptions, UpsertMessageFunction, openai };
